...
function child_enqueue_styles() {
    ...
    wp_enqueue_style('pro-child', get_stylesheet_directory_uri() . '/build/index.css', array(), '2.0.9');
    wp_enqueue_script('spark-js', get_stylesheet_directory_uri() . '/build/index.js', array(), '1.0.5', true);
}

...
// $title = __('Profile Information', 'pmpro-register-helper');
// return $title;
// }
    ...
    if (class_exists('PMProRH_Field')) {
        ...
        $fields[] = new PMProRH_Field(
            ...
            array(
                ...
                // 'levels' => array(1, 2),
                'depends' => array(array('id' => 'member_type', 'value' => 'church'))
            )
        );
        ...
        $fields[] = new PMProRH_Field(
            ...
            array(
                ...
                // 'levels' => array(1, 2),
                'depends' => array(array('id' => 'member_type', 'value' => 'candidate'))
            )
        );

...
function socials() {
  ...
  socialContainer.forEach(el => {
    ...
    el.innerHTML = ''; // Step 3:  Create HTML
    ...
    if (anchor.innerText.includes('linkedin')) swapHTML(link, el, 'Linkedin'); // Step 4: Apply Styles
...
function init() {
  ...
  if (URL.includes('profile')) {
    (0,_modules_profileScripts__WEBPACK_IMPORTED_MODULE_1__.socials)();
  }
